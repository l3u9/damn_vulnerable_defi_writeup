...
describe('[Challenge] Free Rider', function () {
    ...
    it('Execution', async function () {
        ...
        const Contract = await ethers.getContractFactory('FreeRiderExploit');
        const contract = await Contract.connect(player).deploy(uniswapPair.address, marketplace.address, weth.address, devsContract.address)
