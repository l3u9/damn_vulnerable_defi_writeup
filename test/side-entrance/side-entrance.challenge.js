...
describe('[Challenge] Side entrance', function () {
    ...
    it('Execution', async function () {
        ...
        const Contract = await ethers.getContractFactory('SideEntranceExploit');
        const contract = await Contract.connect(player).deploy(pool.address);
        console.log("before Exploit", await contract._balanceOf());
        console.log(await contract.exploit());
        console.log("after Exploit", await contract._balanceOf());
